...
const pageData = {
  "slug": "divisorias-drywall-sp",
  "title": "Divisórias em Drywall SP | D/vox Drywall",
  "description": "Divisórias em drywall em São Paulo para escritórios, salas comerciais, empresas, lojas e ambientes corporativos. Atendimento na capital, Grande SP e interior.",
  "kicker": "Divisórias em drywall SP",
  "h1": "Divisórias em drywall para escritórios, empresas e ambientes comerciais",
  "intro": "A D/vox Drywall executa divisórias em drywall para otimizar espaços com rapidez, acabamento limpo e visual profissional em ambientes comerciais, residenciais, corporativos e prediais.",
  "image": "/assets/projetos/divisoria-drywall.jpg",
  "sections": [
    {
      "title": "Divisórias para otimização de espaços",
      "text": "As divisórias em drywall permitem criar salas, separar ambientes, organizar áreas internas e modernizar espaços sem grandes intervenções estruturais. É uma solução eficiente para empresas, escritórios, consultórios e comércios."
    },
    {
      "title": "Acabamento limpo e profissional",
      "text": "Além da agilidade de execução, o drywall permite receber pintura, iluminação, portas, isolamento e acabamentos personalizados, entregando um resultado moderno e funcional."
    },
    {
      "title": "Atendimento em São Paulo",
      "text": "Atuamos em São Paulo capital, Grande São Paulo e interior paulista com soluções em divisórias, paredes técnicas, forros e acabamentos para obras de diferentes portes."
    }
  ],
  "faqs": [
    {
      "question": "Divisória em drywall é resistente?",
      "answer": "Sim. Quando bem executada, a divisória em drywall oferece boa resistência, acabamento profissional e ótimo desempenho para ambientes internos."
    },
    {
      "question": "Dá para usar em escritório?",
      "answer": "Sim. É uma solução muito usada em escritórios para criar salas, reuniões, recepções e áreas administrativas."
    },
    {
      "question": "Vocês fazem divisórias para empresas?",
      "answer": "Sim. A D/vox atende empresas, comércios, galpões, escritórios, obras corporativas e prediais."
    }
  ],
  "keywords": [
    "divisórias drywall SP",
    "divisórias em drywall São Paulo",
    "paredes de drywall",
    "drywall para escritório"
  ]
};
