...
const pageData = {
  "slug": "drywall-em-sao-paulo",
  "title": "Drywall em São Paulo | D/vox Drywall",
  "description": "Empresa de drywall em São Paulo para obras residenciais, comerciais, corporativas, industriais e prediais. Atendemos São Paulo capital, Grande SP e interior paulista.",
  "kicker": "Drywall em São Paulo",
  "h1": "Empresa de drywall em São Paulo para obras de todos os portes",
  "intro": "A D/vox Drywall executa paredes, revestimentos, divisórias, forros e acabamentos em drywall para residências, escritórios, comércios, galpões, obras corporativas e prediais em São Paulo capital, Grande São Paulo e interior paulista.",
  "image": "/assets/projetos/drywall-1.jpg",
  "sections": [
    {
      "title": "Execução profissional em drywall",
      "text": "O drywall é uma solução moderna para criar, dividir e transformar ambientes com rapidez, limpeza e acabamento de alto padrão. A D/vox atua com planejamento técnico, materiais adequados e execução organizada para obras pequenas, médias e grandes."
    },
    {
      "title": "Onde aplicar drywall",
      "text": "O sistema pode ser utilizado em salas comerciais, escritórios, apartamentos, casas, lojas, consultórios, áreas corporativas, galpões e obras prediais. Também permite integração com iluminação, sancas, isolamento e acabamentos personalizados."
    },
    {
      "title": "Atendimento em SP e interior",
      "text": "Atendemos São Paulo capital, Grande São Paulo e cidades do interior paulista, levando soluções completas para quem busca empresa de drywall com responsabilidade, qualidade e compromisso com prazo."
    }
  ],
  "faqs": [
    {
      "question": "Drywall é indicado para obras comerciais?",
      "answer": "Sim. O drywall é muito usado em escritórios, lojas, salas comerciais, empresas, galpões e ambientes corporativos pela agilidade de execução e acabamento limpo."
    },
    {
      "question": "A D/vox atende obras grandes?",
      "answer": "Sim. A D/vox tem experiência em obras residenciais, comerciais, corporativas, industriais e prediais, incluindo projetos de médio e grande porte."
    },
    {
