...
const pageData = {
  "slug": "drywall-industrial-sp",
  "title": "Drywall Industrial SP | D/vox Drywall",
  "description": "Drywall industrial em São Paulo para galpões, empresas, obras corporativas, divisórias, forros, steel frame e acabamentos técnicos.",
  "kicker": "Drywall industrial SP",
  "h1": "Drywall industrial em São Paulo para obras comerciais, galpões e empresas",
  "intro": "A D/vox Drywall oferece soluções em drywall industrial para empresas, galpões, áreas corporativas, obras prediais e ambientes comerciais que precisam de execução técnica, agilidade e acabamento profissional.",
  "image": "/assets/projetos/galpao-14.jpg",
  "sections": [
    {
      "title": "Execução técnica para obras industriais",
      "text": "Obras industriais exigem soluções práticas, resistentes e bem planejadas. A D/vox atua com drywall, forro modular, divisórias, paredes técnicas e steel frame para ambientes empresariais e industriais."
    },
    {
      "title": "Drywall para empresas e áreas corporativas",
      "text": "Criamos salas, áreas administrativas, divisórias internas, forros e acabamentos para melhorar a organização e funcionalidade de ambientes industriais e corporativos."
    },
    {
      "title": "Atendimento em todo o estado de São Paulo",
      "text": "A D/vox atende São Paulo capital, Grande São Paulo e interior paulista, com capacidade para obras pequenas, médias e grandes."
    }
  ],
  "faqs": [
    {
      "question": "O que é drywall industrial?",
      "answer": "É a aplicação de sistemas em drywall em ambientes industriais, galpões, empresas e obras de maior porte, geralmente com foco em organização, divisórias, forros e áreas administrativas."
    },
    {
      "question": "A D/vox atende obras de grande porte?",
      "answer": "Sim. A D/vox atua em obras residenciais, comerciais, corporativas, industriais e prediais, incluindo projetos de médio e grande porte."
    },
    {
      "question": "Vocês trabalham com steel frame?",
      "answer": "Sim. A D/vox trabalha com steel frame, drywall, forro modular, divisórias e acabamentos."
    }
  ],
  "keywords": [
    "drywall industrial SP",
    "drywall para indústria",
    "drywall para empresas",
    "drywall galpão São Paulo"
  ]
};
