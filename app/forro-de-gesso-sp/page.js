...
const pageData = {
  "slug": "forro-de-gesso-sp",
  "title": "Forro de Gesso SP | D/vox Drywall",
  "description": "Forro de gesso em São Paulo com acabamento premium, sancas, iluminação embutida, rebaixos e soluções modernas para residências, empresas e obras.",
  "kicker": "Forro de gesso SP",
  "h1": "Forro de gesso em São Paulo com acabamento moderno e alto padrão",
  "intro": "A D/vox Drywall executa forro de gesso, rebaixos, sancas, rasgos de luz e iluminação embutida para ambientes residenciais, comerciais e corporativos em São Paulo, Grande SP e interior paulista.",
  "image": "/assets/projetos/forro-de-gesso.jpg",
  "sections": [
    {
      "title": "Acabamento em gesso para valorizar ambientes",
      "text": "O forro de gesso permite criar ambientes modernos, elegantes e funcionais, com integração de iluminação, detalhes arquitetônicos e acabamento sofisticado."
    },
    {
      "title": "Sancas, rebaixos e iluminação",
      "text": "A D/vox executa sancas, rebaixos em gesso, rasgos de luz e soluções personalizadas para salas, quartos, escritórios, lojas, recepções e ambientes comerciais."
    },
    {
      "title": "Execução com padrão profissional",
      "text": "Cada projeto é desenvolvido com atenção ao alinhamento, acabamento e organização da obra, garantindo resultado limpo e compatível com projetos residenciais e corporativos."
    }
  ],
  "faqs": [
    {
      "question": "Forro de gesso combina com iluminação embutida?",
      "answer": "Sim. O gesso é muito utilizado para criar sancas, rasgos de luz e iluminação embutida."
    },
    {
      "question": "Vocês fazem forro de gesso para comércio?",
      "answer": "Sim. Atendemos residências, escritórios, lojas, empresas, ambientes corporativos e obras prediais."
    },
    {
      "question": "Atendem interior de São Paulo?",
