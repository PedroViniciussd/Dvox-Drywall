...
const pageData = {
  "slug": "forro-modular-sp",
  "title": "Forro Modular SP | D/vox Drywall",
  "description": "Instalação de forro modular em São Paulo para empresas, escritórios, galpões, comércios e obras corporativas. Atendimento em SP, Grande SP e interior paulista.",
  "kicker": "Forro modular SP",
  "h1": "Instalação de forro modular em São Paulo para empresas e obras corporativas",
  "intro": "A D/vox Drywall executa forro modular para ambientes comerciais, corporativos, industriais e prediais, com foco em acabamento técnico, organização, manutenção facilitada e padrão profissional.",
  "image": "/assets/projetos/galpao-12.jpg",
  "sections": [
    {
      "title": "Forro modular para ambientes profissionais",
      "text": "O forro modular é muito utilizado em escritórios, lojas, clínicas, escolas, galpões e áreas corporativas por oferecer acabamento uniforme, praticidade e facilidade de acesso a instalações elétricas, ar-condicionado e infraestrutura técnica."
    },
    {
      "title": "Solução para comércios e galpões",
      "text": "A D/vox atua em projetos comerciais e industriais com instalação de forro modular, forro mineral, soluções em gesso e integração com iluminação, sempre respeitando o planejamento da obra."
    },
    {
      "title": "Atendimento regional",
      "text": "Executamos projetos em São Paulo capital, Grande São Paulo e interior paulista, atendendo empresas que precisam de forro modular com qualidade, prazo e acabamento de alto padrão."
    }
  ],
  "faqs": [
    {
      "question": "Forro modular é indicado para empresas?",
      "answer": "Sim. É uma das soluções mais utilizadas em ambientes corporativos e comerciais por facilitar manutenção e organização das instalações."
    },
    {
      "question": "Vocês instalam forro modular em galpões?",
      "answer": "Sim. A D/vox atende galpões, obras industriais, comércios, escritórios e projetos corporativos."
    },
    {
      "question": "O forro modular combina com iluminação?",
      "answer": "Sim. Ele pode ser integrado com luminárias, sistemas elétricos e soluções de iluminação para ambientes profissionais."
    }
  ],
  "keywords": [
    "forro modular SP",
